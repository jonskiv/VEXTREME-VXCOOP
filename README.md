...
These demo files are intended as a proof of concept, so while they may prove useful, they are provided AS-IS without any warranty.  They are likely corrections and enhancements to be made, but offered her for visibility and potential learning. Please do your own research. Besides the examples here, I was able to demonstrate a working game demo using similar routines here in a working development game called [Falcon Wars: Corellian Dog Fights](https://caeolotronics.blogspot.com/2026/09/new-game-in-development-falcon-wars.html).
